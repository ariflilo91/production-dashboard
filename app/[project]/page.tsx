...
export default function ProjectPage({ params }: { params: { project: string } }) {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-base)' }}>
      ...
      {modal && <TaskModal modal={modal} departments={departments} episodes={episodes} teamMembers={teamMembers} onSave={saveTask} onDelete={removeTask} onClose={() => setModal(null)} />}
