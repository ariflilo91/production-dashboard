    ...
    <div style={{ display: 'flex', minHeight: '100vh', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-base)' }}>
      <div style={{ width: '100%', maxWidth: 380, padding: '0 20px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <div style={{ fontSize: 20, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 6 }}>Durioo In-house Production</div>
          <div style={{ fontSize: 13, color: 'var(--text-dim)' }}>Sign in to access your studio dashboard</div>
        </div>
        ...
        {error === 'not_durioo' && (
          <div style={{ background: 'var(--red-bg)', border: '1px solid var(--red-bdr)', borderRadius: 10, padding: '12px 16px', marginBottom: 20, fontSize: 13, color: 'var(--red)', textAlign: 'center' }}>
            Only <strong>@durioo.com</strong> accounts are allowed.
          </div>
        )}
        {error === 'auth_failed' && (
          <div style={{ background: 'var(--red-bg)', border: '1px solid var(--red-bdr)', borderRadius: 10, padding: '12px 16px', marginBottom: 20, fontSize: 13, color: 'var(--red)', textAlign: 'center' }}>
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-sub)', borderRadius: 14, padding: 28, textAlign: 'center' }}>
          <div style={{ fontSize: 13, color: 'var(--text-dim)', marginBottom: 24, lineHeight: 1.6 }}>
            Use your <strong style={{ color: 'var(--text-primary)' }}>@durioo.com</strong> Google account to sign in.
          </div>
          ...
          <div style={{ marginTop: 20, fontSize: 11, color: 'var(--text-faint)', lineHeight: 1.6 }}>
            Access is restricted to Durioo team members.<br />
